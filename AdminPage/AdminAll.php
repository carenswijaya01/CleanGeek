...
/*Nyiapin sql*/
$order_id_Temp = " select Order_id from orders where Statuss = 'In Progress'";
$service_Temp = " select Service from orders where Statuss = 'In Progress'";
$price_Temp = " select Price from orders where Statuss = 'In Progress'";
$request_date_Temp = " select Date from orders where Statuss = 'In Progress'";
$address_Temp = " select Address from orders where Statuss = 'In Progress'";
$status_Temp = " select Statuss from orders where Statuss = 'In Progress'";
    ...
    <header>
        <nav>
            ...
            <ul class="links">
                    ...
                    <li class="active"><a href="../AdminPage/AdminAll.php">In Progress</a></li>
                    <li><a href="../AdminPage/AdminHistory.php">History</a></li>
                    <div class="button">
