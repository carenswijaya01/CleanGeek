...
$order_id_Temp = " select Order_id from orders where Statuss = 'In Progress' and User_id= '$userid'";
$service_Temp = " select Service from orders where Statuss = 'In Progress' and User_id= '$userid'";
$price_Temp = " select Price from orders where Statuss = 'In Progress' and User_id= '$userid'";
$request_date_Temp = " select Date from orders where Statuss = 'In Progress' and User_id= '$userid'";
$address_Temp = " select Address from orders where Statuss = 'In Progress' and User_id= '$userid'";
$status_Temp = " select Statuss from orders where Statuss = 'In Progress' and User_id= '$userid'";
...
<Div style="text-align: center; padding-bottom: 30px">
  <a href="../Status/StatusLoginHistory.php"><button style="background-color:black; color:white; padding: 10px 20px" >History</button></a>
</Div>
</body>
